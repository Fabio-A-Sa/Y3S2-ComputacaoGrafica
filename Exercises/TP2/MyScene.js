...
import { MyUnitCubeQuad } from "./MyUnitCubQuad.js";
...
export class MyScene extends CGFscene {
  ...
  display() {
    ...
    // Exercise 1 - Display Tangram
    // if(this.displayTangram) this.tangram.display();

    // Exercise 2 - Display Unit Cube
    // this.pushMatrix();
    // this.rotate(this.toRadians(-90), 1, 0, 0);
    ...
    // Exercise 3 - Display Unit Cube Quad
    this.pushMatrix();
    this.rotate(this.toRadians(-90), 1, 0, 0);
    this.translate(0.5, -0.5, 0);
    if(this.displayTangram) this.tangram.display();
